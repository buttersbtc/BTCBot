...
class Utilities(commands.Cog):
	...
	async def exchanges(self, ctx, *args):
		exchangeDic = {
			...
			"poland": "BitBay",
			"ukraine": "Kuna",
			"uk": "Strike, Bitstamp, Coinbase, Gemini, Kraken, OKCoin, Binance, Bittylicious, CoinCorner, Coinfloor, CoinJar, Relai",
			"nigeria": "Luno, BuyCoins",
			"south africa": "Luno",
			"uganda": "Binance",
			"canada": "BullBitcoin, BitcoinWell",
			"mexico": "Bitso, Volabit",
			"usa": "River Financial, CashApp, Strike, Bitcoin Well",
