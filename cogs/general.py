...
class General(commands.Cog):
	...
	async def ff(self, ctx, *args):
		fun_facts = ["**Fun Fact:** Bitcoin is the first decentralized digital currency",
					...
					"**Fun Fact:** There is no free Bitcoin. There are only spam and scams.",
					...
					"**Fun Fact:** Half of Bitcoiners identify as left leaning, while the other half identify as right leaning. Bitcoin is for everyone who chooses to verify.",
					...
					"**Fun Fact:** Michael Saylor told noobies to buy the top with debt and remortgage their homes, says Bitcoin isn't a currency, spreads environmental FUD, and attempts to coordinate large groups of miners. If you listen to him you're as big a fool as he is.",
					"**Fun Fact:** Andreas Antonopolis is a scamming shitcoiner who spreads FUD and misinformation out of both ignorance and a desire to lead his followers.",
					...
					"**Fun Fact:** Middlemen want to capture you and your business, but Bitcoin means you don't need them. So stop enabling middlemen, especially custodians. Opt for low trust businesses that leverage Bitcoin's innate features to keep them in your posession."
					]
